...
bot = telebot.TeleBot('8084714055:AAEX4QlZY5rB-_WtQN2rDOtvl61afZQZXqI')
...
def log_command(user_id, target, port, time):
    ...
    if user_info.username:
        username = "@ZEXONOP009" + user_info.username
    else:
...
def welcome_start(message):
    ...
    response = f'''🙏 ROCKET 🚀 PAID BOT BY @ZEXONOP009 🙏'''
    bot.reply_to(message, response)
