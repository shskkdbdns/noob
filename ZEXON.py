...
bot = telebot.TeleBot('8084714055:AAHnS5z6bVRFU3H7cbla3wov-yQeQQ2HkcQ')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @ZEXONOP009."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @ZEXONOP009 ."
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"CHUDAI start : {target}:{port} for {time}\nSEC Jabtak YE Attack run krrha hai to iske bichme koi Attack nahe Dalna Behenchod"
    bot.reply_to(message, response)
...
Buy From :- @ZEXONOP009
Official Channel :- https://t.me/XCLANOP
'''
...
def welcome_start(message):
    ...
    response = f'''🔥ZEXON ke BOT pe aapka swagat hai, {user_name}! Sabse acche se bgmi ki maa behen yahi hack karta hai. Kharidne ke liye Kira se sampark karein.
