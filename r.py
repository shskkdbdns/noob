...
bot = telebot.TeleBot('8084714055:AAH5JsPgj2ylIE2HQZwa1ze9THN5HMaNonw')
...
def create_random_key():
    key = "ZEXON_PAMPA-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 ZEXON 𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃!", reply_markup=markup)
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                response = (
                    ...
                    f"𝗔𝘁𝘁𝗮𝗰𝗸𝗲𝗿: SBR KR LOVDE ALREADY ATTACK CHAL RHA HAI"
                )
